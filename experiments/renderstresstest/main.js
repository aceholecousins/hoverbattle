...
import { scene, run } from '../quickthree.js';
let nTube = 250;
let nRing = 200;
let nObjs = 100;
let nLights = 50;
...
for (let i = 0; i < nObjs; i++) {
    ...
    let model = new THREE.Mesh(geom, new THREE.MeshStandardMaterial({
...
for (let i = 0; i < nLights; i++) {
    ...
    let light = new THREE.PointLight(new THREE.Color(r, g, b), 0.1);
